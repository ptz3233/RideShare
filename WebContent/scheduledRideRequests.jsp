...
<title>Scheduled Ride Requests</title>
</head>
<body>


<h1>Scheduled Ride Requests</h1>
		<%
				...
				String str = "SELECT * FROM rideRequest WHERE requester = \'" + entity +"\'";
				...
				while (result.next()&&counter<15) {
					...
					out.println("<tr>");
					out.print("<td>"+result.getString("requestDate")+"</td>");
				...
				out.println("</table>");
				if(counter==0)
					out.println("You have no requested rides at this point in time!");
				out.println("</center>");
				con.close();
