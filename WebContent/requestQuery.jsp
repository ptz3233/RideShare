...
<body>
	...
	String insert = "INSERT INTO rideRequest(requestID, requestDate, pickUpTime,pickUpLocation, dropOffLocation,requester, recurring) " + "VALUES (?, ?, ?, ?,?,?, ?)";
